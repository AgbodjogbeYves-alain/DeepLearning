...
from Normale_Equation import normalEquation
...
print colored("Bonus : Equation Normale de la regression logistique : \n",'red', attrs=['bold'])
print("Vecteur de parametres retourne par le resultat de l'equation normale :")
theta = normalEquation(X, y)
print("theta = ")
print theta
print("\n")

print("Affichage du modele appris avec l'equation normale :")
plotData(X_plot, y)
line_X = np.arange(X.min(), X.max())
line_y = theta[0] + line_X * theta[1]

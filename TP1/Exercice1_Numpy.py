...
x = 3
print("x = %d" % x)
print("Le type de x est : %s" % type(x)) # Affiche "<class 'int'>"

#declarer un floatant
y = 4.2
print("y = %d" % y)
print("Le type de y est : %s" % type(y)) # Affiche "<class 'float'>"
...
print("On Incremente x=%d de 2 en affectant automatiquement cette nouvelle valeur a x :" % x)
x += 2
...
print("x a la puissance 2 = %d" % (x **2))  	#Affiche "x a la puissance 2 = 9"
...
print("Voici une list non vide: l = ")
l = [11, 5, 9, 10]
print(l)
print("\n")
...
print("Le nombre d'elements dans l est : %d" % len(l))
print("Le nombre d'elements dans l_empty est : %d" % len(l_empty))
...
print("On boucle sur les elements de l pour les afficher un a un avec leur indice correspondant:")
...
print("Vecteur nul dans R 2 (2 dimension reelles):")  #  # Affiche "array([ 0.,  0.])""
b = np.zeros(2)
print(b)
print("\n")

print("Vecteur remplie de 1 dans R 5:")  #    # Affiche "array([ 1.,  1.,  1.,  1.,  1.])""
c = np.ones(5)
print(c)
print("\n")

print("Vecteur aleatoire dans R 4:")  #
...
print("Recuperez les 3 premieres composantes du vecteur x")
print(x[:3])
print("\n")

#Recuperez les 3 derniere composante composantes
print("Recuperez les 3 dernieres composantes")
dim = x.shape[0]
print( x[dim-3:] )
print("\n")

#Recuperez les composantes de 3 a la derniere
print("Recuperez les composantes de 3 a la derniere")
print(x[3:])
print("\n")

#Recuperez les composantes alant de l'indice 3 a 7
print("Recuperez les composantes alant de l'indice 3 a 7")
print(x[3:7])
print("\n")

#Donnez la dimension du vecteur avec 'shape' de numpy
print("On peut retrouver la dimension du vecteur x avec la commande np.shape(x)")
print(np.shape(x))
print("\n")

print("On peut aussi retrouver la dimension du vecteur x avec la commande x.shape")
print(x.shape)
print("\n")

#Recuperation de la dimension de l'espace de representation vectoriel
# a partir du tuple renvoye par shape
shape = x.shape
dim_x = shape[0]
print("Recuperation de la dimension a partir du tuple renvoye par shape: dim_x = x.shape[0] = %d" % dim_x)
print("\n")
pause()
#########################################################
...
print("Matrice nulle dans 2x2:")  #
M1 = np.zeros((2,2))
print(M1)
print("\n")

print("Matrice 3x3 remplie de 1:")  #
M2 = np.ones((3,3))  		#ICI TU DOIS CODER
print(M2)
print("\n")

print("Matrice 4x4 aleatoire:")  #
M3 = np.random.random((4,4))
print(M3)
print("\n")

print("Matrice identite 5x5:")  #
M4 = np.eye(5,5) 		#ICI TU DOIS CODER
print(M4)
print("\n")
...
shape = M1.shape       # #ICI TU DOIS CODER ###
print("Les dimensions de la matrice M1:")
print(shape)
print("\n")
...
nb_lignes 	= shape[0]
nb_colonnes	= shape[1]
print("nb_lignes de M1 = %d" % nb_lignes)
print("nb_colonnes de M1 = %d" % nb_colonnes)
print("\n")
pause()
######################################################""
...
print("Parcourez les vecteurs lignes de la matrice M2 en bouclant directement sur les elements du vecteur")
print("M2=")
print(M2)
print("\n")
...
matrix_product = 0.0
M3 = np.random.random((10,4))       #ICI TU DOIS CODER
print("M3  =")
print(M3)
print("\n")
